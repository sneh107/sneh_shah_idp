 ...
 * @brief Functions for searching and filtering mobiles.
 *
 * This file contains functions for searching and filtering mobiles based on
 * price range, configuration (RAM, storage, chipset, camera), and user input.
 * It includes functions for displaying mobiles within a specified price range
 * and based on specific configuration parameters.
 *
 * Author       - Sneh Shah
 *
 *******************************************************************************
