 ...
 * Description:
 * @file deleteMobile.c
 * @brief Functions for deleting mobile data from the database.
 *
 * This file contains functions responsible for deleting mobile data from the database.
 * It includes functions for displaying outdated mobiles, validating mobile IDs,
 * confirming user actions, and deleting mobile records.
 *
 * Author       - Sneh Shah
 *
 *******************************************************************************
