 ...
 * Description:
 * @file addMobile.c
 * @brief Functions for adding mobile data to the database.
 *
 * This file contains functions responsible for adding mobile data to the database.
 * It includes functions for checking if a mobile already exists, generating a unique
 * ID for the mobile, saving the mobile data to the database, and the main function
 * for adding a new mobile.
 *
 * Author       - Sneh Shah
 *
 *******************************************************************************
