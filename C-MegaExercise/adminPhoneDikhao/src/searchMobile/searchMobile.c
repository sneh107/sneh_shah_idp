 ...
 * Description:
 * @file searchMobile.c
 * @brief Functions for searching mobile data in the database.
 *
 * This file contains functions responsible for searching mobile data in the database.
 * It includes functions for searching by mobile name, brand name, displaying search
 * options menu, and handling search results.
 *
 * Author       - Sneh Shah
 *
 *******************************************************************************
